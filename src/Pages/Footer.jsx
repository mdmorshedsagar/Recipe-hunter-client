...
<footer className="footer p-10 bg-base-200 text-base-content">
        <div>
          <img className='w-[200px] h-[60px]' src={logo} alt="yumma_logo"  />
          <p>ACME Industries Ltd.<br/>Providing reliable tech since 1992</p>
        </div> 
        <div>
          <span className="footer-title">Categories</span> 
          <a className="link link-hover">Breakfast Recipes</a> 
          <a className="link link-hover">Lunch Recipes</a> 
          <a className="link link-hover">Dinner Recipes</a> 
          <a className="link link-hover">Drink Recipes</a>
          <a className="link link-hover">Appetizer & Snack</a>
        </div> 
        <div>
          ...
          <a className="link link-hover">Content Licensing</a>
        </div> 
        <div>
